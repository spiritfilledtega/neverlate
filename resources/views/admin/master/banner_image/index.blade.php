        ...
        <div class="box">
            <div class="box-header with-border">
                <div class="row text-right">
                    ...
                    @if(auth()->user()->can('add-banner-image'))                         
                    <div class="col-12 text-right">
                        <a href="{{url('banner_image/create')}}" class="btn btn-primary btn-sm">
                            <i class="mdi mdi-plus-circle mr-2"></i>@lang('view_pages.add_banner_image')</a>
                    </div>
                   @endif
