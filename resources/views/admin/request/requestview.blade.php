...
<style>
    ...
    <section class="content">
        <div class="row">
            <div class="col-12">
<!-- 
                <a href="{{ route('invoice2',$item->id) }}">
                    <button class="btn btn-success btn-sm pull-right mb-3" type="submit">
    ...
    @endif
                        ...
                        <div class="row d-flex justify-content-center">
                            ...
                            <button id="ajaxButton1" type="button" class="btn btn-info btn-md mx-3" style="align-content: center;">
                                <span id="ajaxButtonText" class="text-white">@lang('view_pages.download_customer_invoice')</span>
                            </button>



                            <button id="ajaxButton" type="button" class="btn btn-info btn-md" style="align-content: center;">
                                <span id="ajaxButtonText" class="text-white">@lang('view_pages.download_driver_invoice')</span>
                            </button>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            ajaxButton.addEventListener("click", function() {
                // Get the item ID from the button's href attribute
                var itemId = "<?php echo $item->id; ?>";

                // Construct the URL
                var url = "{{ url('requests/view-driver-invoice-direct') }}/" + itemId;
        ...
        document.addEventListener("DOMContentLoaded", function() {
            // Get the button element
            var ajaxButton = document.getElementById("ajaxButton1");
            ...
            ajaxButton.addEventListener("click", function() {
                ...
                // Construct the URL
                var url = "{{ url('requests/view-customer-invoice-direct') }}/" + itemId;
