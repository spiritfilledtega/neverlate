...
<div class="content">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="box">
                <div class="box-header with-border">
                    <a href="{{ url('company/drivers/document/view',$driver->id) }}">
        ...
        <div class="col-sm-12">
            <form  method="post" class="form-horizontal" action="{{url('company/drivers/upload/document',[$driver->id,$needed_document->id])}}" enctype="multipart/form-data">
            {{csrf_field()}}
