...
<div class="content">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="box">
                <div class="box-header with-border">
                    <a href="{{ url('fleets/document/view',$fleet->id) }}">
        ...
        <div class="col-sm-12">
            <form  method="post" class="form-horizontal" action="{{url('fleets/upload/document',[$fleet->id,$needed_document->id])}}" enctype="multipart/form-data">
            {{csrf_field()}}
                    ...
                    @if ($needed_document->has_identify_number)
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="identify_number" name="identify_number" value="{{ old('identify_number',$fleetDoc ? $fleetDoc->identify_number : '') }}" required="" placeholder="@lang('view_pages.identify_number')">
                    ...
                    @if ($needed_document->has_expiry_date)
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control datepicker" type="text" id="expiry_date" name="expiry_date" value="{{old('expiry_date',$fleetDoc ? $fleetDoc->expiry_date : '')}}" required="" placeholder="@lang('view_pages.enter_expiry_date')" autocomplete="off">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <img id="blah" src="{{ $fleetDoc ? $fleetDoc->image : '' }}" alt=""><br>
...
$('.datepicker').datepicker({
  ...
  format: 'yyyy-mm-dd',
  startDate: 'today',
  endDate: '+100y' // Allow dates up to 100 years from today
});
</script>
@endsection