...
{{csrf_field()}}
                        ...
                        @endif
                                    ...
                                    <div class="col-6" name="taxi" id="taxi" >
                                        ...
                                        <input class="form-control" type="number" id="capacity" name="capacity" value="{{old('capacity')}}"  placeholder="@lang('view_pages.enter_capacity')" min="1">
                                    ...
                                    <div class="col-6" name="delivery" id="delivery">
                                        ...
                                        <input class="form-control" type="text" id="maximum_weight_can_carry" name="maximum_weight_can_carry" value="{{old('capacity')}}" placeholder="@lang('view_pages.enter_maximum_weight_can_carry')" min="1">
                                        <span class="text-danger">{{ $errors->first('maximum_weight_can_carry') }}</span>
                                    </div>
                                </div>
                                <div class="col-6" name="delivery_1" id="delivery_1">
                                        <div class="form-group m-b-25">
                                        <label for="name">@lang('view_pages.size') <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" id="size" name="size" value="{{old('size')}}" placeholder="@lang('view_pages.enter_size')" min="1">
                       ...
                       <div class="col-6">
                            ...
                            <div class="col-6">
                                        <div class="form-group">
                                            <label for="">@lang('view_pages.trip_dispatch_type') <span class="text-danger">*</span></label>
                                            <select name="trip_dispatch_type" id="trip_dispatch_type" class="form-control" required>
                                                <option value="" selected disabled>@lang('view_pages.select')</option>
                                                <option value="bidding" {{ old('trip_dispatch_type') == 'bidding' ? 'selected' : '' }}>@lang('view_pages.bidding')</option>
                                                <option value="normal" {{ old('trip_dispatch_type') == 'normal' ? 'selected' : '' }}>@lang('view_pages.normal')</option>
                                            </select>
...
<script>
    function check_taxi(){
        if($('#capacity').val().length > 0){
            ...
            $('capacityErr').html('Capacity is Required');
            return false;
        }
    }
    function check_delivery(){
        if($('#maximum_weight_can_carry').val().length > 0){
            if($('#size').val().length > 0){
                $('sizeErr').html('');
                return true;
            }else{
                $('sizeErr').html('Size is required');
            }
            $('maximumErr').html('');
        }else{
            $('maximumErr').html('Maximum Weight is Required');
        }
        return false;
    }
