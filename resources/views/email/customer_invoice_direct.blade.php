...
<script>
    ...
    // Call autoPrint() and redirectToPreviewPage() after the document is ready
...
<button id="printBtn" style="display: none">Print and Save as PDF</button>
