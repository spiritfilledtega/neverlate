...
class DriverDocumentController extends BaseController
{
    ...
    public function index(Driver $driver)
    {
        ...
        return view('admin.company-driver.drivers.documents.index', compact('page', 'main_menu', 'sub_menu', 'driver', 'neededDocument', 'driverDoc'));
    }
    ...
    public function documentUploadView(Driver $driver, DriverNeededDocument $needed_document)
    {
        ...
        return view('admin.company-driver.drivers.documents.upload', compact('page', 'main_menu', 'sub_menu', 'driver', 'needed_document', 'driverDoc'));
    }
    ...
    public function uploadDocument(DriverDocumentUploadRequest $request, Driver $driver, DriverNeededDocument $needed_document)
    {
        ...
        return redirect("company/drivers/document/view/$driver->id");
    }
