...
//cashfree   Not completed
    Route::get('cashfree', 'CashfreeController@index');
    Route::get('cashfree/payment/success', 'CashfreeController@cashfreeCheckout')->name('cashfree.success');
    Route::post('/cashfree/callback', 'CashfreeController@handleCallback')->name('cashfree.callback');
